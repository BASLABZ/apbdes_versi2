...
class Spp_ extends GI_Controller
{
	...
	public function simpan_tambah()
	{
		...
		if($this->db->trans_status()) {
			...
			// show_error('Gagal menambah data SPP.');
			// echo "gagal";
			// show_error
	...
	public function simpan_ubah()
	{
		...
		$url_spp_rincian = 'spp2/rincian/' . implode('-', array($post['KODEURUSAN'], $post['KODESUBURUSAN'], $post['KODEORGANISASI'], $post['KODEDESA'])) . '?nomor=' . urlencode(@$post['NO_SPP']);
