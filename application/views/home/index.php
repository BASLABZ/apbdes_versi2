						...
						<div class="widget red-bg p-lg text-center dim">
		                    <div class="row">
		                        ...
		                        <div class="col-xs-8 text-right">
		                            <span> Informasi Pembuatan Data </span>
					...
					<div class="col-md-3">
						<div class="widget navy-bg p-lg text-center dim">
		                    <div class="row">
		                        ...
		                        <div class="col-xs-8 text-right">
		                            <span> Informasi Verifikasin SPP </span>
		                            <h3 class="font-bold">Persetujuan </h3>
						...
						<div class="widget widget style1 yellow-bg p-lg text-center dim">
		                    <div class="row">
		                        ...
		                        <div class="col-xs-8 text-right">
		                            ...
		                            <h3 class="font-bold">Laporan Buku Kas Umum</h3>
