<div class="ibox"><div class="ibox-title"><h5><span class="fa fa-print"></span> Cetak</h5></div>
	<div class="ibox-content highlight-bas">
		<form id="print_cetak_form" action="javascript:void(0);">
			...
			<button type="submit" class="btn btn-primary bd-rad-0 dim"><span class="fa fa-print"></span> Cetak</button>
