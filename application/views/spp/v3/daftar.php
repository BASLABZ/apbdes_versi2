...
<div class="ibox">
	...
	<div class="ibox-title"><h5><span class="fa fa-list"></span> Daftar SPP</h5></div>
	<div class="ibox-content highlight-bas">
...
<?php if (!$is_kosong): ?><?php $this->load->view('spp/misc/print'); ?><script>
winload(function() {
...
winload(function() {
	...
	$('#spp-inp-inst').val(slc_val).select2().on('change', function() {
		...
		if (!first) location.href = u_index;
