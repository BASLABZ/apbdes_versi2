...
<div class="ibox"><div class="ibox-title"><h5><span class="glyphicon glyphicon-align-justify"></span> Rincian SPP</h5></div>
	<div class="ibox-content highlight-bas">
		<div class="row">
			<div class="col-md-8">
				...
				<table class="table table-condensed mg-0 h5" id="sppinfo">
					<tr>
						...
						<td>:</td>
						<td><b><?php echo $dataspp['URAI_KEC'], ' - ', $dataspp['URAI_DESA'] ?></b></td>
					</tr>
					<tr>
						<td>Kegiatan</td>
						<td>:</td>
			...
			<div class="col-md-4 text-right">
				<!-- <a onclick="ke_cetak_form()" class="btn btn-success btn-xs bd-rad-0"><span class="glyphicon glyphicon-print"></span> Cetak</a> -->
				<?php if ($is_allow_edit): ?>
					<!-- <a onclick="spp_rem_fn(function() { location.href = location.href.replace(/spp2\/rincian/, 'spp5/hapus');  })" class="btn btn-danger btn-xs bd-rad-0"><span class="glyphicon glyphicon-remove"></span> Hapus</a> -->
					<!-- <a onclick="location.href = location.href.replace(/spp2\/rincian/, 'spp5/ubah')" class="btn btn-warning btn-xs bd-rad-0"><span class="glyphicon glyphicon-pencil"></span> Ubah</a> -->
				<?php endif ?>
			    <a href="<?php echo base_url('spp2/index') ?>" class="btn btn-info btn-xs bd-rad-0"><span class="glyphicon glyphicon-th-list"></span> Daftar</a>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<table class="table table-bordered mg-0" id="list_pajak">
						...
						<?php endforeach ?>
						<?php if ($kosong): ?><tr><td class="text-center" colspan="2">Pajak Tidak Tersedia.</td></tr><?php endif ?>
					</table>
				</div>
			</div>
			<div class="hr-line-dashed"></div>
